...
import com.grt.tally.AboutActivity;
import com.grt.tally.HistoryActivity;
import com.grt.tally.ChartActivity;
import com.grt.tally.R;
import com.grt.tally.SettingActivity;

public class MoreDialog extends Dialog implements View.OnClickListener {
    Button aboutBtn,settingBtn,historyBtn,infoBtn,chartBtn;
    ImageView errorIv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartBtn = findViewById(R.id.dialog_more_btn_chart);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.dialog_more_btn_info:
                ...
                getContext().startActivity(intent);
                break;
            case R.id.dialog_more_btn_chart:
                intent.setClass(getContext(), ChartActivity.class);
                getContext().startActivity(intent);
                break;
