...
import com.grt.tally.adapter.AccountAdapter;
import com.grt.tally.db.AccountBean;
import com.grt.tally.db.DBManager;
import com.grt.tally.utils.BudgetDialog;
import com.grt.tally.utils.MoreDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        searchIv.setColorFilter(getResources().getColor(R.color.theme_color));

        //查找头布局可用控件
        headerView = findViewById(R.id.lly_main_top);
        ...
        topShowIv.setColorFilter(getResources().getColor(R.color.theme_color));
